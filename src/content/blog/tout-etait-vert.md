...
<svg viewBox="0 0 700 304" role="img" aria-labelledby="ttl-inv desc-inv" style="width:100%;min-width:660px;height:auto;background:#fbfaf7;border:1px solid #e6e6e6">
...
<text x="30" y="30" font-family="ui-monospace,monospace" font-size="11" letter-spacing="1.6" fill="#6e6e6e">INVENTAIRE</text>
<text x="670" y="30" text-anchor="end" font-family="ui-monospace,monospace" font-size="11" letter-spacing="1.6" fill="#9a9a9a">2 – 18 AOÛT 2026</text>
<line x1="30" y1="44" x2="670" y2="44" stroke="#101010" stroke-width="1.5"/>
<text x="30" y="74" font-family="ui-monospace,monospace" font-size="13" fill="#6e6e6e">Jours</text><text x="670" y="74" text-anchor="end" font-family="Archivo,Helvetica,Arial,sans-serif" font-weight="600" font-size="17" fill="#101010" style="font-variant-numeric:tabular-nums">16</text><line x1="30" y1="84" x2="670" y2="84" stroke="#efefef" stroke-width="1"/><text x="30" y="103" font-family="ui-monospace,monospace" font-size="13" fill="#6e6e6e">Commits</text><text x="670" y="103" text-anchor="end" font-family="Archivo,Helvetica,Arial,sans-serif" font-weight="600" font-size="17" fill="#101010" style="font-variant-numeric:tabular-nums">478</text><line x1="30" y1="113" x2="670" y2="113" stroke="#efefef" stroke-width="1"/><text x="30" y="132" font-family="ui-monospace,monospace" font-size="13" fill="#6e6e6e">Lignes de code</text><text x="670" y="132" text-anchor="end" font-family="Archivo,Helvetica,Arial,sans-serif" font-weight="600" font-size="17" fill="#101010" style="font-variant-numeric:tabular-nums">28 000</text><line x1="30" y1="142" x2="670" y2="142" stroke="#efefef" stroke-width="1"/><text x="30" y="161" font-family="ui-monospace,monospace" font-size="13" fill="#6e6e6e">Programmes</text><text x="670" y="161" text-anchor="end" font-family="Archivo,Helvetica,Arial,sans-serif" font-weight="600" font-size="17" fill="#101010" style="font-variant-numeric:tabular-nums">9</text><line x1="30" y1="171" x2="670" y2="171" stroke="#efefef" stroke-width="1"/><text x="30" y="190" font-family="ui-monospace,monospace" font-size="13" fill="#6e6e6e">Dépôts</text><text x="670" y="190" text-anchor="end" font-family="Archivo,Helvetica,Arial,sans-serif" font-weight="600" font-size="17" fill="#101010" style="font-variant-numeric:tabular-nums">5</text><line x1="30" y1="200" x2="670" y2="200" stroke="#efefef" stroke-width="1"/><text x="30" y="219" font-family="ui-monospace,monospace" font-size="13" fill="#6e6e6e">Chaînes de vérification automatique</text><text x="670" y="219" text-anchor="end" font-family="Archivo,Helvetica,Arial,sans-serif" font-weight="600" font-size="17" fill="#101010" style="font-variant-numeric:tabular-nums">14</text><line x1="30" y1="229" x2="670" y2="229" stroke="#efefef" stroke-width="1"/>
<line x1="30" y1="250" x2="670" y2="250" stroke="#101010" stroke-width="1.5"/>
<text x="30" y="278" font-family="ui-monospace,monospace" font-size="13" fill="#0b6a63">Lignes que j'ai écrites moi-même</text>
<text x="670" y="282" text-anchor="end" font-family="Archivo,Helvetica,Arial,sans-serif" font-weight="700" font-size="30" fill="#0b6a63">0</text>
</svg>
</div>
</figure>
...
<figure>
<div style="overflow-x:auto;-webkit-overflow-scrolling:touch">
<svg viewBox="0 0 700 366" role="img" aria-labelledby="t-loop d-loop" style="width:100%;min-width:660px;height:auto;background:#fbfaf7;border:1px solid #e6e6e6">
...
<rect x="30" y="20" width="260" height="34" fill="none" stroke="#e6e6e6" stroke-dasharray="4 4"/>
<text x="46" y="42" font-family="ui-monospace,monospace" font-size="12" letter-spacing="1.2" fill="#9a9a9a">UN BESOIN HUMAIN</text>
<line x1="90" y1="58" x2="90" y2="70" stroke="#c9c5bd" stroke-width="1" stroke-dasharray="3 3"/>
<line x1="83" y1="76" x2="97" y2="88" stroke="#0b6a63" stroke-width="1.5"/>
<line x1="97" y1="76" x2="83" y2="88" stroke="#0b6a63" stroke-width="1.5"/>
<text x="112" y="86" font-family="ui-monospace,monospace" font-size="12" fill="#0b6a63">aucun lien</text>
<rect x="30" y="96" width="500" height="38" fill="#f4f2ed" stroke="#e6e6e6"/><rect x="30" y="96" width="3" height="38" fill="#0b6a63"/><text x="48" y="120" font-family="ui-monospace,monospace" font-size="12" fill="#0b6a63">01</text><text x="80" y="120" font-family="Archivo,Helvetica,Arial,sans-serif" font-weight="600" font-size="15" fill="#101010">Répartiteur de tâches</text><line x1="90" y1="138" x2="90" y2="152" stroke="#6e6e6e" stroke-width="1"/><path d="M86 148 L90 154 L94 148" fill="#6e6e6e"/><text x="106" y="153" font-family="ui-monospace,monospace" font-size="12" fill="#6e6e6e">fait apparaître le besoin de…</text><rect x="30" y="158" width="500" height="38" fill="#f4f2ed" stroke="#e6e6e6"/><rect x="30" y="158" width="3" height="38" fill="#0b6a63"/><text x="48" y="182" font-family="ui-monospace,monospace" font-size="12" fill="#0b6a63">02</text><text x="80" y="182" font-family="Archivo,Helvetica,Arial,sans-serif" font-weight="600" font-size="15" fill="#101010">Moteur de politiques</text><line x1="90" y1="200" x2="90" y2="214" stroke="#6e6e6e" stroke-width="1"/><path d="M86 210 L90 216 L94 210" fill="#6e6e6e"/><text x="106" y="215" font-family="ui-monospace,monospace" font-size="12" fill="#6e6e6e">fait apparaître le besoin de…</text><rect x="30" y="220" width="500" height="38" fill="#f4f2ed" stroke="#e6e6e6"/><rect x="30" y="220" width="3" height="38" fill="#0b6a63"/><text x="48" y="244" font-family="ui-monospace,monospace" font-size="12" fill="#0b6a63">03</text><text x="80" y="244" font-family="Archivo,Helvetica,Arial,sans-serif" font-weight="600" font-size="15" fill="#101010">Journal d'audit</text><line x1="90" y1="262" x2="90" y2="276" stroke="#6e6e6e" stroke-width="1"/><path d="M86 272 L90 278 L94 272" fill="#6e6e6e"/><text x="106" y="277" font-family="ui-monospace,monospace" font-size="12" fill="#6e6e6e">fait apparaître le besoin de…</text><rect x="30" y="282" width="500" height="38" fill="#f4f2ed" stroke="#e6e6e6"/><rect x="30" y="282" width="3" height="38" fill="#0b6a63"/><text x="48" y="306" font-family="ui-monospace,monospace" font-size="12" fill="#0b6a63">04</text><text x="80" y="306" font-family="Archivo,Helvetica,Arial,sans-serif" font-weight="600" font-size="15" fill="#101010">Console d'opérateur</text>
<path d="M530 301 L576 301 L576 115 L536 115" fill="none" stroke="#6e6e6e" stroke-width="1" stroke-dasharray="4 3"/>
<path d="M542 111 L534 115 L542 119" fill="#6e6e6e"/>
<text x="586" y="211.0" font-family="ui-monospace,monospace" font-size="12" fill="#6e6e6e">et ainsi</text>
<text x="586" y="227.0" font-family="ui-monospace,monospace" font-size="12" fill="#6e6e6e">de suite</text>
</svg>
</div>
<figcaption style="font-family:ui-monospace,monospace;font-size:12.5px;color:#6e6e6e;line-height:1.6;margin-top:10px">Chaque étage justifiait le suivant. Aucun ne remontait jusqu'en haut.</figcaption>
</figure>
...
<figure>
<div style="overflow-x:auto;-webkit-overflow-scrolling:touch">
<svg viewBox="0 0 698 128" role="img" aria-labelledby="ttl-vert desc-vert" style="width:100%;min-width:660px;height:auto;background:#fbfaf7;border:1px solid #e6e6e6">
...
<text x="30" y="26" font-family="ui-monospace,monospace" font-size="11" letter-spacing="1.6" fill="#6e6e6e">AOÛT 2026 — CHAÎNES D'INTÉGRATION</text>
...
<text x="30" y="92" font-family="ui-monospace,monospace" font-size="11" fill="#9a9a9a">2 août</text>
<text x="570" y="92" text-anchor="end" font-family="ui-monospace,monospace" font-size="11" fill="#9a9a9a">18 août</text>
<line x1="582" y1="48" x2="582" y2="74" stroke="#e6e6e6" stroke-width="1" stroke-dasharray="3 3"/>
<rect x="606" y="46" width="62" height="30" fill="#f8e9e9" stroke="#e0b8b8"/>
<text x="637" y="66.0" text-anchor="middle" font-family="ui-monospace,monospace" font-size="15" fill="#0b6a63">&#10007;</text>
<text x="637" y="92" text-anchor="middle" font-family="ui-monospace,monospace" font-size="11" fill="#0b6a63">21 août</text>
</svg>
</div>
<figcaption style="font-family:ui-monospace,monospace;font-size:12.5px;color:#6e6e6e;line-height:1.6;margin-top:10px">Seize jours où tout passait. Le seul essai qui comptait est venu après.</figcaption>
</figure>
...
<figure>
<div style="overflow-x:auto;-webkit-overflow-scrolling:touch">
<svg viewBox="0 0 700 332" role="img" aria-labelledby="t-pile d-pile" style="width:100%;min-width:660px;height:auto;background:#fbfaf7;border:1px solid #e6e6e6">
...
<text x="30" y="26" font-family="ui-monospace,monospace" font-size="11" letter-spacing="1.6" fill="#6e6e6e">CE QUI ÉTAIT VÉRIFIÉ</text>
<text x="245" y="58" text-anchor="end" font-family="ui-monospace,monospace" font-size="12.5" fill="#101010">Tests automatisés</text><line x1="261" y1="54" x2="316" y2="54" stroke="#6e6e6e" stroke-width="1"/><path d="M312 50 L320 54 L312 58" fill="#6e6e6e"/><text x="245" y="98" text-anchor="end" font-family="ui-monospace,monospace" font-size="12.5" fill="#101010">Revue de code</text><line x1="261" y1="94" x2="316" y2="94" stroke="#6e6e6e" stroke-width="1"/><path d="M312 90 L320 94 L312 98" fill="#6e6e6e"/><text x="245" y="138" text-anchor="end" font-family="ui-monospace,monospace" font-size="12.5" fill="#101010">Chaîne de vérification</text><line x1="261" y1="134" x2="316" y2="134" stroke="#6e6e6e" stroke-width="1"/><path d="M312 130 L320 134 L312 138" fill="#6e6e6e"/><text x="245" y="178" text-anchor="end" font-family="ui-monospace,monospace" font-size="12.5" fill="#101010">Déploiement</text><line x1="261" y1="174" x2="316" y2="174" stroke="#6e6e6e" stroke-width="1"/><path d="M312 170 L320 174 L312 178" fill="#6e6e6e"/>
<rect x="330" y="28" width="340" height="164" fill="#f4f2ed" stroke="#e6e6e6"/>
<text x="500.0" y="116.0" text-anchor="middle" font-family="Archivo,Helvetica,Arial,sans-serif" font-weight="600" font-size="17" fill="#101010">Est-ce conforme ?</text>
<line x1="30" y1="240" x2="670" y2="240" stroke="#e6e6e6" stroke-width="1" stroke-dasharray="4 4"/>
<text x="245" y="286" text-anchor="end" font-family="ui-monospace,monospace" font-size="12.5" fill="#b8b4ac">(rien)</text>
<line x1="261" y1="282" x2="316" y2="282" stroke="#e6e6e6" stroke-width="1" stroke-dasharray="3 3"/>
<rect x="330" y="260" width="340" height="44" fill="none" stroke="#0b6a63" stroke-width="1.5"/>
<text x="500.0" y="288" text-anchor="middle" font-family="Archivo,Helvetica,Arial,sans-serif" font-weight="600" font-size="17" fill="#0b6a63">Est-ce que ça devait exister ?</text>
</svg>
</div>
<figcaption style="font-family:ui-monospace,monospace;font-size:12.5px;color:#6e6e6e;line-height:1.6;margin-top:10px">Quatre dispositifs pour la première question. Aucun pour la seconde.</figcaption>
</figure>

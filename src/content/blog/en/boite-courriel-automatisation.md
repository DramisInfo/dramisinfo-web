---
title: "The inbox: automation's blind spot in small business"
description: "Email eats up nearly 30% of the workweek, yet it's the last process most businesses dare to automate. Here's why — and how to fix it without losing the human voice."
pubDate: 2026-07-09
lang: en
...
<div class="stat" data-reveal><span class="stat-num">28<span class="stat-unit">%</span></span><span class="stat-label">of the workweek spent managing email</span></div>
<div class="stat" data-reveal><span class="stat-num">42<span class="stat-unit"> hrs</span></span><span class="stat-label">average company response time to an inbound inquiry</span></div>
</div>
...
<figcaption class="chart-title">Company response time to an inbound inquiry (HBR, study of 2,241 companies)</figcaption>
<div class="bar-row"><span class="bar-label">Within the hour</span><span class="bar-track"><span class="bar-fill" style="--w:37%"></span></span><span class="bar-val">37%</span></div>
<div class="bar-row"><span class="bar-label">1 to 24 hours</span><span class="bar-track"><span class="bar-fill bar-fill--muted" style="--w:16%"></span></span><span class="bar-val bar-val--muted">16%</span></div>
<div class="bar-row"><span class="bar-label">More than 24 hours</span><span class="bar-track"><span class="bar-fill bar-fill--muted" style="--w:24%"></span></span><span class="bar-val bar-val--muted">24%</span></div>
<div class="bar-row"><span class="bar-label">No response at all</span><span class="bar-track"><span class="bar-fill bar-fill--muted" style="--w:23%"></span></span><span class="bar-val bar-val--muted">23%</span></div>
<p class="chart-note">The study looked at sales inquiries specifically, but the principle applies to any inbound request: the longer the wait, the colder the relationship.</p>
</figure>
...
- Harvard Business School — research brief on *The Short Life of Online Sales Leads*: [hbs.edu](https://www.hbs.edu/faculty/Pages/item.aspx?num=39955)

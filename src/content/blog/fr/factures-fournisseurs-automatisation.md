...
icon: invoice
tags: ["Facturation", "Automatisation"]
coverImage: /images/blog/invoice-automation.jpg
---
...
1. **Réception** : les factures arrivent par courriel dans une boîte dédiée ou via un portail fournisseur
2. **Extraction** : le système lit le document et structure les données
3. **Validation** : les exceptions (champs manquants, écarts de montant) sont signalées pour révision humaine

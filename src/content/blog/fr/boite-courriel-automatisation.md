---
title: "La boîte courriel, angle mort de l'automatisation en PME"
description: "Le courriel avale près de 30 % de la semaine de travail, mais reste le dernier processus qu'on ose automatiser. Voici pourquoi — et comment y arriver sans perdre la voix humaine."
pubDate: 2026-07-09
lang: fr
permalink: boite-courriel-automatisation
icon: mail
tags: ["Courriel", "Service client"]
coverImage: /images/blog/email-triage.jpg
---
...
<div class="stat" data-reveal><span class="stat-num">28<span class="stat-unit">%</span></span><span class="stat-label">de la semaine de travail consacrée aux courriels</span></div>
<div class="stat" data-reveal><span class="stat-num">42<span class="stat-unit"> h</span></span><span class="stat-label">délai de réponse moyen des entreprises à une demande entrante</span></div>
</div>
...
<figcaption class="chart-title">Délai de réponse des entreprises à une demande entrante (HBR, étude auprès de 2 241 entreprises)</figcaption>
<div class="bar-row"><span class="bar-label">Dans l'heure</span><span class="bar-track"><span class="bar-fill" style="--w:37%"></span></span><span class="bar-val">37%</span></div>
<div class="bar-row"><span class="bar-label">1 à 24 heures</span><span class="bar-track"><span class="bar-fill bar-fill--muted" style="--w:16%"></span></span><span class="bar-val bar-val--muted">16%</span></div>
<div class="bar-row"><span class="bar-label">Plus de 24 heures</span><span class="bar-track"><span class="bar-fill bar-fill--muted" style="--w:24%"></span></span><span class="bar-val bar-val--muted">24%</span></div>
<div class="bar-row"><span class="bar-label">Jamais de réponse</span><span class="bar-track"><span class="bar-fill bar-fill--muted" style="--w:23%"></span></span><span class="bar-val bar-val--muted">23%</span></div>
<p class="chart-note">Cette étude portait sur des demandes commerciales, mais le principe s'applique à toute demande entrante : plus l'attente s'allonge, plus la relation se refroidit.</p>
</figure>
...
Dans nos articles précédents, on a vu comment l'automatisation règle [la double saisie dans un CRM](/blog/en-finir-double-saisie-crm/) ou [le traitement des factures fournisseurs](/blog/factures-fournisseurs-automatisation/). Ces deux cas partagent une caractéristique commune : les données sont **structurées**. Un montant est un montant. Un numéro de facture est un numéro de facture. Une machine peut les extraire, les valider et les classer avec fiabilité.
...
**2. Automatiser le répétitif avec des réponses-modèles.** Pour les catégories bien identifiées et à faible risque — confirmer un rendez-vous, renvoyer une facture déjà émise, indiquer les heures d'ouverture — une réponse automatique, personnalisée avec les bonnes informations, peut partir en quelques secondes au lieu d'attendre le prochain moment de disponibilité de l'équipe. C'est exactement le principe décrit dans notre article sur [l'ingénierie des flux de travail](/blog/ingenierie-flux-travail/) : une automatisation déterministe et prévisible, réservée aux cas où la bonne réponse est claire.
...
- McKinsey Global Institute — *The Social Economy: Unlocking value and productivity through social technologies* : [mckinsey.com](https://www.mckinsey.com/industries/technology-media-and-telecommunications/our-insights/the-social-economy)
- Oldroyd, McElheran, Elkington — *The Short Life of Online Sales Leads*, Harvard Business Review : [hbr.org](https://hbr.org/2011/03/the-short-life-of-online-sales-leads)
- Harvard Business School — fiche de recherche sur l'étude *The Short Life of Online Sales Leads* : [hbs.edu](https://www.hbs.edu/faculty/Pages/item.aspx?num=39955)
- Mark, Gudith, Klocke — *The Cost of Interrupted Work: More Speed and Stress*, Proceedings of the SIGCHI Conference on Human Factors in Computing Systems (ACM) : [dl.acm.org](https://dl.acm.org/doi/10.1145/1357054.1357072)
